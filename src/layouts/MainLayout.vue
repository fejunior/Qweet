    ...
    >
      ...
      <q-list bordered>
        <q-item to="/" clickable v-ripple exact>
          ...
          <q-item-sectio class="text-h6">Home</q-item-sectio>
        </q-item>
        <q-item to="/about" clickable v-ripple exact>
          ...
          <q-item-sectio class="text-h6">About</q-item-sectio>
        </q-item>
      </q-list>
    </q-drawer>

    <q-drawer show-if-above v-model="rightDrawerOpen" side="right" bordered>
      <q-input class="q-ma-md" type="text" label="Search" outlined rounded>
      ...
      <q-list separator padding>
        <q-item class="q-pa-md">
          <q-item-section>
            ...
            <q-item-label class="text-weigth-bold"
